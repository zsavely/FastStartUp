...
import static com.szagurskii.superfaststartup.splash.SplashModule.OBSERVABLE_JSON_STRING;
...
public final class SplashActivity extends AppCompatActivity implements OnInitCallbacks {
  ...
  @Inject @Named(OBSERVABLE_JSON_STRING) Observable<String> splashLibraryObservable;
    ...
    subscription = splashLibraryObservable
        ...
        .subscribe(new Observer<String>() {
          ...
          @Override public void onError(Throwable e) {
            Log.d(TAG, "Couldn't fetch shit.", e);
          }

          @Override public void onNext(String s) {
            Log.d(TAG, "Fetched shit " + s);
  ...
  private static final class OnInitObserver implements Observer<SplashLibrary> {
    @NonNull private OnInitCallbacks onInitCallbacks;
